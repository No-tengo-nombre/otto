...
from otto_utils.console import ShellColors


LOGGER = logging.Logger("otto")
...
class CustomFormatter(logging.Formatter):
    """Custom formatter for the otto logger"""
...
def setup_logger(quiet=False, debug=False, verbose=False, log_dir=False):
    ...
    debug : bool, optional
        ...
        functionality that might be useful when debugging a otto
