...
const char *_OTTO_KERNELS_CORE[] = {
    OTTO_CLKERNEL("buffer/elementary.cl"),
    OTTO_CLKERNEL("matrix/elementary.cl"),
};
const char *_OTTO_KERNELS_CORE_NAMES[] = {
    // Buffers
    "otto_buffer_add__u8",
    "otto_buffer_add__u16",
    "otto_buffer_add__u32",
    "otto_buffer_add__u64",
    "otto_buffer_add__i8",
    "otto_buffer_add__i16",
    "otto_buffer_add__i32",
    "otto_buffer_add__i64",
    "otto_buffer_add__f32",
    "otto_buffer_add__f64",

    "otto_buffer_sub__u8",
    "otto_buffer_sub__u16",
    "otto_buffer_sub__u32",
    "otto_buffer_sub__u64",
    "otto_buffer_sub__i8",
    "otto_buffer_sub__i16",
    "otto_buffer_sub__i32",
    "otto_buffer_sub__i64",
    "otto_buffer_sub__f32",
    "otto_buffer_sub__f64",

    "otto_buffer_mul__u8",
    "otto_buffer_mul__u16",
    "otto_buffer_mul__u32",
    "otto_buffer_mul__u64",
    "otto_buffer_mul__i8",
    "otto_buffer_mul__i16",
    "otto_buffer_mul__i32",
    "otto_buffer_mul__i64",
    "otto_buffer_mul__f32",
    "otto_buffer_mul__f64",

    "otto_buffer_div__u8",
    "otto_buffer_div__u16",
    "otto_buffer_div__u32",
    "otto_buffer_div__u64",
    "otto_buffer_div__i8",
    "otto_buffer_div__i16",
    "otto_buffer_div__i32",
    "otto_buffer_div__i64",
    "otto_buffer_div__f32",
    "otto_buffer_div__f64",

    "otto_buffer_dot__i32",
